...
const vercel_1 = __nccwpck_require__(5875);
    ...
    processEnvVariable(envVariableKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingTargets.length === 0) {
                core_1.info(`No existing variable found for ${envVariableKey}${this.gitBranchInfoTextSnippet(gitBranch)}, creating.`);
                ...
                core_1.info(`Existing variable found for ${envVariableKey}${this.gitBranchInfoTextSnippet(gitBranch)}, comparing values.`);
    ...
    createEnvVariable({ type, key, value, targets, gitBranch, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(createResponse === null || createResponse === void 0 ? void 0 : createResponse.data)) {
                core_1.info(`Variable ${key}${this.gitBranchInfoTextSnippet(gitBranch)} with targets ${targets.join(",")} created successfully`);
            }
        });
    }
    processPossibleEnvVariableUpdate({ type, value, targets, existingVariables, gitBranch, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            existingVariable.gitBranch === gitBranch &&
                ...
                core_1.info(`Value, target or type for env variable ${existingVariable.key}${this.gitBranchInfoTextSnippet(gitBranch)} has found to have changed, updating value`);
                ...
                if (patchResponse === null || patchResponse === void 0 ? void 0 : patchResponse.data) {
                    core_1.info(`${existingVariable.key}${this.gitBranchInfoTextSnippet(gitBranch)} updated successfully.`);
                }
            }
            else {
                core_1.info(`No change found for ${existingVariable.key}${this.gitBranchInfoTextSnippet(gitBranch)}, skipping...`);
            }
        });
    }
    gitBranchInfoTextSnippet(gitBranch) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __nccwpck_require__(2186);
const VercelEnvVariabler_1 = __importDefault(__nccwpck_require__(689));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
